...
function buildPromptText(text, markupPercent) {
  return (
    ...
    'اقرأ وصف الطلب والصور المرفقة (إن وُجدت) لبضائع/مواد مستخدمة في العمل، ثم أعد قائمة ببنود الفاتورة المقترحة. ' +
    'لكل بند أعطِ: name (اسم البند بالعربية، مختصر وواضح كما يُكتب في فاتورة فنية)، qty (الكمية المقدَّرة كرقم)، ' +
    'unit_cost (تكلفة الوحدة التقديرية بالدولار الأميركي كرقم، بناءً على أسعار السوق اللبناني التقريبية لمواد التكييف والكهرباء والسباكة وقت الطلب). ' +
    'لا تُضف نسبة الربح بنفسك، فهي ستُطبَّق برمجيًا بعد ذلك. ' +
    'أعد الإجابة بصيغة JSON فقط دون أي نص إضافي قبله أو بعده وبدون Markdown، بالشكل التالي حرفيًا: ' +
    '{"items":[{"name":"...","qty":1,"unit_cost":0}], "notes":"ملاحظة قصيرة اختيارية بالعربية إن لزم"}. ' +
    '\n\nوصف الطلب من الفني:\n' + (text || '(لا يوجد وصف نصي، استند إلى الصور فقط)') +
